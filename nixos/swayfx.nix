{pkgs, ...}: {
  wayland.windowManager.sway = {
    ...
    extraConfig = ''
      ...
      # Additional config to allow programs to open a window and run. Based on above.
      for_window [app_id="^float-win$"] floating enable
      ...
      set $desktop_wallpaper /run/current-system/sw/share/backgrounds/sway/Sway_Wallpaper_Blue_1920x1080.png
      set $lock_screen /run/current-system/sw/share/backgrounds/sway/Sway_Wallpaper_Blue_1920x1080.png
      ### Output configuration
      #
      # Default wallpaper (more resolutions are available in /usr/share/backgrounds/sway/)
      output * bg $desktop_wallpaper fill
      #
      ...
      #
      exec swayidle -w \
               timeout 300 'swaylock -e -f -i $lock_screen' \
               timeout 600 'swaymsg "output * power off"' resume 'swaymsg "output * power on"' \
               before-sleep 'swaylock -e -f -i $lock_screen'
      #
      ...
      #
          # Lock desktop
          bindsym $mod+Control+l exec swaylock -e -f -i $lock_screen
          ...
          # sloppytop
          bindsym $mod+Escape exec kitty --class=float-win -o initial_window_width=150c -o initial_window_height=40c -e btop
      ...
      bindswitch --reload --locked lid:off output $laptop pos 0 0 enable
      ...
      input $intuos_pad map_to_output eDP-1
      input $intuos_pen map_to_output eDP-1
